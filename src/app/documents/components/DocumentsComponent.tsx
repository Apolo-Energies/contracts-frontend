    ...
    const onSubmitFinal = async () => {
        ...
        try {
            ...
            const payload = {
                ...
                name: person.name,
                phone: person.phone,
                lastName: person.surname1 ?? "",
                secondLastName: person.surname2 ?? "",
                flowType: 0,
                ...
                dni: person.dni ?? "",
                legalAddress: `${person.legalStreetType ?? ""} ${person.legalStreetName ?? ""}`.trim(),
                legalNumber: person.legalNumber ?? "",
                notificationAddress: `${person.notificationStreetType ?? ""} ${person.notificationStreetName ?? ""}`.trim(),
                notificationNumber: person.notificationNumber ?? "",
                cityLegal: person.legalCity ?? "",
                cityNotification: person.notificationCity ?? "",
                postalCodeLegal: person.postalCodeLegal ?? "",
                postalCodeNotification: person.postalCodeNotification ?? "",
                cif: person.cif ?? "",
